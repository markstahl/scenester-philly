...
const MovieShow = (props) => {
  let background_image = {backgroundImage: `url(https://getreelcinemas.com//wp-content/uploads/2015/02/Background-Narrow.jpg)`, backgroundSize: 'cover', backgroundPosition: 'center' };
